defmodule Afterbuy.Tesla.Middleware.BaseUrl do
  @moduledoc """
  ...
  defp apply_base(%Tesla.Env{url: url} = env, base) when is_function(base),
    do: apply_base(%{env | url: base.(env, url)}, "")

  defp apply_base(%Tesla.Env{url: nil} = env, base),
    do: apply_base(%{env | url: ""}, base)
